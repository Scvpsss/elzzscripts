...
PW_DEFAULT() {
    ...
    local password_url="https://raw.githubusercontent.com/Scvpsss/elzzscripts/main/configure/password"
...
LIMIT_HANDLER() {
    ...
    wget https://raw.githubusercontent.com/Scvpsss/elzzscripts/main/LimitHandler/install.sh && chmod +x install.sh && ./install.sh
...
BOT_SHELL() {
   ...
   wget https://raw.githubusercontent.com/Scvpsss/elzzscripts/main/LTbotVPN/SHELLBOT
    unzip SHELLBOT
    mv LTBOTVPN /usr/bin
